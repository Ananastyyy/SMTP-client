...
class Client:
    ...
    def _create_connect(self):
        try:
            ...
            with socket.create_connection((HOST_ADDRESS, PORT), timeout=1) as sock:
                return ssl_contex.wrap_socket(sock, server_hostname=HOST_ADDRESS)
        except SMTPException as e:
            print(e)
